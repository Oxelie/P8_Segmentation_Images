...
mask_paths = sorted(list(TEST_IMAGE_DIR.glob("*Fine_color.png")))
...
print([img.name for img, _ in test_samples])
...
st.image(orig_img, caption="Image originale", use_container_width=True)
